...
<div class="w-full h-full flex-auto block lg:flex overflow-auto lg:overflow-hidden">
	...
	<div class="flex-none lg:flex-[50%] p-4 overflow-x-auto space-y-8">
		...
		<section class="space-y-4">
			...
			<p>
				Shown in <span class="badge variant-soft-secondary">blue</span> - interact and chat with Wissem and other special guests.
			</p>
		...
		<section class="space-y-4">
			...
			<p>
				Shown in <span class="badge variant-soft-primary">pink</span> - each represents a project Wissem has created or contributed to
			</p>
			<!-- Per Each Category -->
