...
export const npcsList: any = (config: any) => {
	return [
		...
		new GameObject({
			...
			dialog: `Bonjour, je suis Wissem. Bienvenue dans mon portfolio interactif ! Ici, vous êtes libre d'explorer un monde virtuel de ma propre création. Vous pouvez appuyer et faire glisser pour vous déplacer. Essayez la <strong class="text-primary-500">Tablette de Pierre</strong> à proximité pour en savoir plus sur moi, ou interagissez avec n'importe quel <strong class="text-primary-500">Pilier</strong> pour consulter les détails de la vaste gamme de projets auxquels j'ai contribué.`,
			interactive: true
		}),
		...
		new GameObject({
			...
			dialog: `Salut, je suis la graphiste de Wissem. Je suis là pour vous aider ! Si vous vous perdez, il vous suffit de toucher le <strong class="text-primary-500">Bouton de Navigation</strong>. Cela vous permettra de naviguer rapidement et facilement entre les personnages disponibles et les projets.`,
			interactive: true
		})
	];
};
